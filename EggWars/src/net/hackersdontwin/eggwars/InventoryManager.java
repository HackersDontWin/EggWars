...
public class InventoryManager {
	...
	private void setupDiamondGeneratorInventory() {
		...
		diamondGeneratorLvl1.setItem(15, newItem(Material.EXP_BOTTLE, 1, getExpName("diamond", 0, 3), getExpLore(10.0,5,"diamond", false)));
		...
		ironGeneratorLvl1.setItem(11, newItem(Material.IRON_INGOT, 1, getMaterialName("iron", 0), getMarialLore(0.0)));
		ironGeneratorLvl1.setItem(15, newItem(Material.EXP_BOTTLE, 1, getExpName("iron", 0, 4), getExpLore(1.0,10,"iron", false)));
		...
		ironGeneratorLvl3.setItem(11, newItem(Material.IRON_INGOT, 1, getMaterialName("iron", 4), getMarialLore(0.25)));
		ironGeneratorLvl3.setItem(15, newItem(Material.EXP_BOTTLE, 1, getExpName("iron", 4, 4), getExpLore(0.0,0,"gold", true)));
	}
	...
	private String getExpName(String type, int currentLevel, int maxLevel) {
		...
		if(currentLevel == maxLevel) {
			...
			if(type.equalsIgnoreCase("iron")) {
				s += ChatColor.YELLOW + ChatColor.BOLD.toString() + "Upgrade to: " + ChatColor.GRAY + ChatColor.BOLD + "Iron " + ChatColor.YELLOW + ChatColor.BOLD + "generator - Level " + currentLevel+1;
			} else if(type.equalsIgnoreCase("gold")) {
				s += ChatColor.YELLOW + ChatColor.BOLD.toString() + "Upgrade to: " + ChatColor.GOLD + ChatColor.BOLD + "Gold " + ChatColor.YELLOW + ChatColor.BOLD + "generator - Level " + currentLevel+1;
			} else if(type.equalsIgnoreCase("diamond")) {
				s += ChatColor.YELLOW + ChatColor.BOLD.toString() + "Upgrade to: " + ChatColor.AQUA + ChatColor.BOLD + "Diamond " + ChatColor.YELLOW + ChatColor.BOLD + "generator - Level " + currentLevel+1;
			}
		}
		return s;
	}
